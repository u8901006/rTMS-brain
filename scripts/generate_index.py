...
<style>
  ...
  *, *::before, *::after {{ box-sizing: border-box; margin: 0; padding: 0; }}
  ...
  .clinic-link {{ display: flex; align-items: center; gap: 14px; padding: 18px 24px; background: var(--surface); border: 1px solid var(--line); border-radius: 16px; text-decoration: none; color: var(--text); transition: all 0.2s; }}
...
<div class="container">
  ...
  <footer>
    <p>Powered by PubMed + NVIDIA NIM (Nemotron 3) · <a href="https://github.com/u8901006/rTMS-brain">GitHub</a></p>
  </footer>
</div>
</body>
</html>"""
